      ...
      <div className="p-4 ">
        ...
        <div className="my-4 flex justify-around">
          <a
            ...
            className="rounded-xl bg-gray-50 px-7 py-2"
          >
          ...
          <a
            ...
            className="rounded-xl bg-gray-50 px-9 py-2"
          >
          ...
          <a
            ...
            className="rounded-xl bg-gray-50 px-[50px] py-2"
          >
        ...
        <p>
          <strong>PJ호텔 정문</strong>으로 오셔서 하객으로 왔다고 해주세요.
          <br />
          호텔 직원이 주차장으로 안내 해드립니다!
        </p>
      </div>
      <Footer />
    </>
